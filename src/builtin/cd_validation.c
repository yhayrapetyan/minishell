...
int	builtin_cd_validation(t_data *data)
{
	...
	if (data->commands->args[0]) // I am sure that I won't get null if it gets to this IF statement, but just in case I do these checks so I 100% don't get seg fault
	{
